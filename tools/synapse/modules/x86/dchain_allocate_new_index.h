...
public:
  DchainAllocateNewIndex() : Module(ModuleType::x86_DchainAllocateNewIndex, Target::x86, "DchainAllocate") {}
...
private:
  ...
  BDD::BDDVisitor::Action visitCall(const BDD::Call* node) override {
    ...
    if (call.function_name == "dchain_allocate_new_index") {
      auto ep_node  = ExecutionPlanNode::build(CREATE_SHARED_MODULE(DchainAllocateNewIndex), node);
