...
public:
  ExpireItemsSingleMap() : Module(ModuleType::x86_ExpireItemsSingleMap, Target::x86, "Expire") {}
...
private:
  ...
  BDD::BDDVisitor::Action visitCall(const BDD::Call* node) override {
    ...
    if (call.function_name == "expire_items_single_map") {
      auto ep_node  = ExecutionPlanNode::build(CREATE_SHARED_MODULE(ExpireItemsSingleMap), node);
