...
public:
  DchainIsIndexAllocated() : Module(ModuleType::x86_DchainIsIndexAllocated, Target::x86, "DchainIsIndexAllocated") {}
...
private:
  ...
  BDD::BDDVisitor::Action visitCall(const BDD::Call* node) override {
    ...
    if (call.function_name == "dchain_is_index_allocated") {
      auto ep_node  = ExecutionPlanNode::build(CREATE_SHARED_MODULE(DchainIsIndexAllocated), node);
